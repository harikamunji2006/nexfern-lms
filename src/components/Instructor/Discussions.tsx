...
import { MessageSquare, Reply, ThumbsUp, Clock, Tag, Search, Plus } from 'lucide-react';
...
const InstructorDiscussions: React.FC = () => {
  ...
  const discussions: Discussion[] = [
    ...
    },
    {
      ...
      content: 'I\'m confused about when to use CSS Grid versus Flexbox. Can someone provide some guidance on the best use cases for each?',
      author: 'Carol Davis',
      authorRole: 'student',
          ...
          <div className="p-6">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
              ...
              <textarea
                ...
                rows={4}
                placeholder="Share your expertise and help the student..."
              />
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Course Discussions</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">Engage with students and answer their questions</p>
        </div>
      </div>
